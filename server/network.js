...
exports.generatePill = async function() {
    let response = {};
    ...
    try {
        ...
        const contract = network.getContract('privatedata_chaincode');

        // Submit the specified transaction.
        // createCar transaction - requires 5 argument, ex: ('createCar', 'CAR12', 'Honda', 'Accord', 'Black', 'Tom')
        await contract.submitTransaction('generatePill', uuid());
        console.log('Transaction has been submitted');

        // Disconnect from the gateway.
        await gateway.disconnect();

        response.msg = 'generatePill Transaction has been submitted';
        return response;
